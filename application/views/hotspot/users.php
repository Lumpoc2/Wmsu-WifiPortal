                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-bordered table-hover" id="dataTable">
                                ...
                                <tbody>
                                    ...
                                    <!-- <?php var_dump($data) ?> -->
                                    <tr>
                                        <?php $id = str_replace('*','',$data[".id"]);$trigger = false; ?>
                                        <th>
                                            <div <?php echo (($data['address']=="10.10.10.6")?"hidden":""); ?>>
                                                <a href="<?= site_url('Hotspot/editUser/' . $id)?>"><i
                                                        class="fa fa-edit" style="color: green"></i></a>
                                                <a href="<?= site_url('Hotspot/delUser/' . $id)?>" class="delete-link"
                                                    data-name="<?= $data['name']; ?>"><i class="fa fa-trash"
                                                        style="color: red"></i></a>
                                            </div>
                                        </th>
                                        <th><?= $data['name']; ?></th>
